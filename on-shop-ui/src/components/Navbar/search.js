...
const prices = [
  {
    name: 'Entre 1 e 50 reais',
    value: '1-50',
  },
  {
    name: 'Entre 50 e 200 reais',
    value: '50-200',
  },
  {
    name: 'Entre 200 e 1000 reais',
    value: '200-1000',
  },
];
                ...
                <Select value={rating} onChange={ratingHandler} fullWidth>
                  ...
                  {ratings.map((rating) => (
                    <MenuItem dispaly="flex" key={rating} value={rating}>
                      ...
                      <Typography component="span"> ou melhor</Typography>
                    </MenuItem>
                  ))}
                </Select>
              </Box>
          ...
          <Grid container justifyContent="space-between" alignItems="center">
            ...
            <Grid item>
              ...
              <Select value={sort} onChange={sortHandler}>
                ...
                <MenuItem value="toprated">Mais bem avaliados</MenuItem>
